...
namespace RemindMe.Controllers
{
    public class RemindMeController : Controller
    {
        ...
        {
            // In the RegisterUser IAction Result in the RemindeMe Controller
            //  the try/catch is necessary in case the User table has no entries.
            //   Once there is at least one entry the try catch codfe is not necessary
            //
            //
            /*
