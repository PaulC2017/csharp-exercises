...
namespace RemindMe.Models
{
    public class User
    {
        ...
        // establishing onbe-to-many relationship:
        //one - User, many - events and reminders

        public List<UserEventTypesRecurring> UserEventTypesRecurring = new List<UserEventTypesRecurring>();
        public List<UserEventTypesNonRecurring> UserEventTypesNonRecurring = new List<UserEventTypesNonRecurring>();

        public List<RecurringReminders> RecurringReminders = new List<RecurringReminders>();
        public List<RecurringReminders> UserRecurringReminders
        {
            get { return RecurringReminders; }
            set { RecurringReminders = value; }
        }



        public List<NonRecurringReminders>NonRecurringReminders = new List<NonRecurringReminders>();
